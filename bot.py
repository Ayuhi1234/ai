...
Introduce_Ans = ["My name is PyBot.","My name is PyBot you can call me pi.","Im PyBot :) ","My name is PyBot and my nickname is pi and i am happy to solve your queries :) "]
